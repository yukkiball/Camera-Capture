...
QT_MOC_LITERAL(1, 14, 14), // "SendAnalogData"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 15), // "QVector<double>"
QT_MOC_LITERAL(4, 46, 16) // "SendFinishSignal"

    },
    "ControlThread\0SendAnalogData\0\0"
    "QVector<double>\0SendFinishSignal"
};
...
void ControlThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendAnalogData((*reinterpret_cast< QVector<double>(*)>(_a[1]))); break;
        case 1: _t->SendFinishSignal(); break;
        default: ;
        }
        ...
        {
            using _t = void (ControlThread::*)(QVector<double> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlThread::SendAnalogData)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlThread::SendFinishSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ControlThread::SendAnalogData(QVector<double> _t1)
{
...
// SIGNAL 1
void ControlThread::SendFinishSignal()
{
