...
QT_MOC_LITERAL(1, 14, 7), // "sendImg"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "sendWidth"
QT_MOC_LITERAL(4, 33, 10), // "sendLength"
QT_MOC_LITERAL(5, 44, 7) // "sendROI"

    },
    "ProcessThread\0sendImg\0\0sendWidth\0"
    "sendLength\0sendROI"
};
...
void ProcessThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendWidth((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 2: _t->sendLength((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 3: _t->sendROI((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProcessThread::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessThread::sendImg)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessThread::sendWidth)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ProcessThread::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessThread::sendLength)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ProcessThread::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessThread::sendROI)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void ProcessThread::sendImg(QImage _t1)
{
...
// SIGNAL 1
void ProcessThread::sendWidth(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ProcessThread::sendLength(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void ProcessThread::sendROI(QImage _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
