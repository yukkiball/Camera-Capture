...
QT_MOC_LITERAL(1, 13, 11), // "connectLost"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "CameraThread\0connectLost\0"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::connectLost)) {
                *result = 0;
                return;
            }
        }
